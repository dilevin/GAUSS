#ifndef ENERGY_STVK_H_FIXED
#define ENERGY_STVK_H_FIXED

#include <cmath>

template<typename DataType, typename ShapeFunction>
class EnergyStvkHFixed : public virtual ShapeFunction{
public:
    template<typename QDOFList, typename QDotDOFList>
    EnergyStvkHFixed(Eigen::MatrixXd &V, Eigen::MatrixXi &F, QDOFList &qDOFList, QDotDOFList &qDotDOFList) : ShapeFunction(V, F, qDOFList, qDotDOFList) {
