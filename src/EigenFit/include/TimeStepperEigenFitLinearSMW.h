//
//  TimeStepperEigenFitLinearSMW.h
//  Gauss
//
...
#ifndef TimeStepperEigenFitLinearSMW_h
#define TimeStepperEigenFitLinearSMW_h
...
namespace Gauss {
    ...
    class TimeStepperImplEigenFitLinearSMWImpl
    {
    public:
        
        template<typename Matrix>
        TimeStepperImplEigenFitLinearSMWImpl(Matrix &P, unsigned int numModes) {
        ...
        TimeStepperImplEigenFitLinearSMWImpl(const TimeStepperImplEigenFitLinearSMWImpl &toCopy) {
            
        }
        
        ~TimeStepperImplEigenFitLinearSMWImpl() { }
...
template<typename DataType, typename MatrixAssembler, typename VectorAssembler>
template<typename World>
void TimeStepperImplEigenFitLinearSMWImpl<DataType, MatrixAssembler, VectorAssembler>::step(World &world, double dt, double t) {
    ...
    if (m_numModes != 0) {
        ...
        static_cast<EigenFitLinear*>(std::get<0>(world.getSystemList().getStorage())[0])->calculateEigenFitLinearData(world.getState(),massMatrixNew,stiffnessMatrixNew,m_coarseUs,Y,Z);
...
template<typename DataType, typename MatrixAssembler, typename VectorAssembler>
using TimeStepperEigenFitLinearSMW = TimeStepper<DataType, TimeStepperImplEigenFitLinearSMWImpl<DataType, MatrixAssembler, VectorAssembler> >;




#endif /* TimeStepperEigenFitLinearSMW_h */
