...
#ifndef RenderableEmbeddedSurface_h
#define RenderableEmbeddedSurface_h
...
namespace Gauss {
    ...
    class Renderable< Embeddings::PhysicalSystemEmbeddedMesh<DataType, System> >: public Renderable<DataType>
    {
    public:
        
        using EmbeddedMesh = Embeddings::PhysicalSystemEmbeddedMesh<DataType, System>;
        
        
        Renderable(EmbeddedMesh *mesh) : Renderable<DataType>() {
            std::cout<<"Renderable PhysicalSystemEmbedded \n";
            m_mesh = mesh;
        }
...
#endif /* RenderableEmbeddedSurface_h */
