...
//typedef scene
typedef PhysicalSystemFEM<double, StvkTet> STVKTet;

typedef World<double, std::tuple<STVKTet *,PhysicalSystemParticleSingle<double> *>,
